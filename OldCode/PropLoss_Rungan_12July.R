...
# Version 5. Run for two sites; had to remove '-' from text file names so that the .wav files would match
...
observed.prop.loss.subset.site1 <- subset(observed.prop.loss.subset,pb.id =='3 (S4A07867)')
